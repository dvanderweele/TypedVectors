...
QUnit.test("insert method.", assert => {
  ...
  const v6 = int8Vector(5, 5);
  const v7 = int8Vector(5, 5);
  const v8 = int8Vector(5, 5);
  const a1 = new Int8Array(2);
  a1[0] = 13;
  a1[1] = 13;
  v6.insert(0,a1);
  ...
  const v9 = int8Vector(5, 5);
  const v10 = int8Vector(5, 5);
  const v11 = int8Vector(5, 5);
