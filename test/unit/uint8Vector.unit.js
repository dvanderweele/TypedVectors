const uint8Vector = require("../../src/uint8Vector.js");

QUnit.module("uint8Vector");

QUnit.test("Instantiation.", assert => {
  const v1 = uint8Vector(3, 2);
  assert.equal(v1.getSize(), 3, "size of 3");
  assert.equal(v1.getCapacity(), 3, "capacity of 3");
  assert.throws(()=>uint8Vector(-1, 1));
...
QUnit.test("front method.", assert => {
  const v1 = uint8Vector();
  const v2 = uint8Vector(1,13);
...
QUnit.test("back method.", assert => {
  const v1 = uint8Vector();
  const v2 = uint8Vector(1, 7);
  const v3 = uint8Vector(2, 3);
...
QUnit.test("insert method.", assert => {
  ...
  const v3 = uint8Vector(5, 5);
  const v4 = uint8Vector(5, 5);
  const v5 = uint8Vector(5, 5);
  ...
  const v6 = uint8Vector(5, 5);
  const v7 = uint8Vector(5, 5);
  const v8 = uint8Vector(5, 5);
  ...
  const v9 = uint8Vector(5, 5);
  const v10 = uint8Vector(5, 5);
  const v11 = uint8Vector(5, 5);
