const int16Vector = require("../../src/int16Vector.js");

QUnit.module("int16Vector");

QUnit.test("Instantiation.", assert => {
  const v1 = int16Vector(3, 2);
  assert.equal(v1.getSize(), 3, "size of 3");
  assert.equal(v1.getCapacity(), 3, "capacity of 3");
  assert.throws(()=>int16Vector(-1, 1));
...
QUnit.test("front method.", assert => {
  const v1 = int16Vector();
  const v2 = int16Vector(1,13);
...
QUnit.test("back method.", assert => {
  const v1 = int16Vector();
  const v2 = int16Vector(1, 7);
  const v3 = int16Vector(2, 3);
...
QUnit.test("MIN and MAX.", assert => {
  const v1 = int16Vector(4);
  v1.set(0, v1.MIN);
  v1.set(1, v1.MAX);
  v1.set(2, (v1.MIN - 1));
  v1.set(3, (v1.MAX + 1));
  assert.equal(v1.at(0), -32768);
  assert.equal(v1.at(1), 32767);
  assert.notEqual(v1.at(2), -32769);
  assert.notEqual(v1.at(3), 32768);
});

QUnit.test("insert method.", assert => {
  const v1 = int16Vector(5, 5);
  ...
  const v3 = int16Vector(5, 5);
  const v4 = int16Vector(5, 5);
  const v5 = int16Vector(5, 5);
  ...
  assert.equal(v3.at(4), -5);
  assert.equal(v3.at(5), -5);
  v4.insert(2, d1);
  ...
  const v6 = int16Vector(5, 5);
  const v7 = int16Vector(5, 5);
  const v8 = int16Vector(5, 5);
  ...
  const v9 = int16Vector(5, 5);
  const v10 = int16Vector(5, 5);
  const v11 = int16Vector(5, 5);
